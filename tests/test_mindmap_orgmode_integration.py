...
class TestMindmapOrgmodeIntegration(unittest.TestCase):
    ...
    def test_end_to_end_project_with_subtasks(self) -> None:
        ...
        self.assertIn("Total: 2h", output)

    def test_end_to_end_mixed_projects_and_worklog(self) -> None:
        """E2E test: Read XML -> Extract data -> Format -> Print with both projects and worklog entries."""
        xml_str = """
        <node TEXT="Root">
    ...
    def test_end_to_end_multiple_dates_sorted(self) -> None:
        """E2E test: Multiple dates are sorted chronologically."""
        xml_str = """
        <node TEXT="Root">
