...
class TestJsonFormatter(unittest.TestCase):
    ...
    def test_parse_date_object_attribute(self) -> None:
        object_str = (
            "org.freeplane.features.format.FormattedDate|2026-01-16T00:00+0400|date"
        )
    ...
    def test_parse_datetime_object_attribute(self) -> None:
        object_str = (
            "org.freeplane.features.format.FormattedDate|2026-01-16T09:00+0400|datetime"
        )
        result = self.formatter._parse_object_attribute(object_str)
    ...
    def test_parse_datetime_with_timezone_plus(self) -> None:
        object_str = (
            "org.freeplane.features.format.FormattedDate|2026-01-16T09:30+0400|datetime"
        )
        result = self.formatter._parse_object_attribute(object_str)
    ...
    def test_parse_datetime_with_timezone_minus(self) -> None:
        object_str = (
            "org.freeplane.features.format.FormattedDate|2026-01-16T09:30-0500|datetime"
        )
        result = self.formatter._parse_object_attribute(object_str)
    ...
    def test_parse_datetime_without_timezone(self) -> None:
        object_str = (
            "org.freeplane.features.format.FormattedDate|2026-01-16T09:30|datetime"
        )
        result = self.formatter._parse_object_attribute(object_str)
    ...
    def test_parse_invalid_datetime(self) -> None:
        object_str = (
            "org.freeplane.features.format.FormattedDate|invalid-datetime|datetime"
        )
        result = self.formatter._parse_object_attribute(object_str)
